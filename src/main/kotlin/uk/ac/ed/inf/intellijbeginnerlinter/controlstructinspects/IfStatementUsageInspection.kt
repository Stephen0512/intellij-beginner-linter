...
class IfStatementUsageInspection : AbstractBaseJavaLocalInspectionTool() {
     ...
     * @return A JavaElementVisitor that will inspect the usage of if statements in Java functions.
     */
    @NotNull
            ...
            override fun visitIfStatement(statement: PsiIfStatement) {
                ...
                if (count > allowance && allowance != -1) {
                    ...
                    if (allowance == 0) {
                        ...
                        holder.registerProblem(
                            statement,
                            "Too many 'if' statements within Java methods '${method.name}' (Allowed: ${allowance}; Used: ${count}).",
                            ProblemHighlightType.WARNING
                        )
                    }
                }
